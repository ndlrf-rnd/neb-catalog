...
run_import "${SOURCE_PATH}/aleph.nlr.ru/20200822_050628_nlr01.iso.gz" aleph.nlr.ru application/marc
run_import "${SOURCE_PATH}/aleph.nlr.ru/20200822_050715_nlr10.iso.gz" aleph.nlr.ru application/marc
run_import "${SOURCE_PATH}/aleph.nlr.ru/20200822_050715_nlr10.iso.gz" aleph.nlr.ru application/marc

#run_import "${SOURCE_PATH}/aleph.nlr.ru/20200822_050628_nlr01.mrc.gz" aleph.nlr.ru application/marc
#run_import "${SOURCE_PATH}/aleph.nlr.ru/20200822_050715_nlr10.mrc.gz" aleph.nlr.ru application/marc
#run_import "${SOURCE_PATH}/aleph.nlr.ru/20200822_050851_nlr11.mrc.gz" aleph.nlr.ru application/marc

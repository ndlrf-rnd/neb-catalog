...
<xsl:stylesheet version="1.0" exclude-result-prefixes="marc"
			...
			<xsl:for-each select="marc:collection">
				<xsl:for-each select="marc:record">
					<record type="Bibliographic">
						<xsl:for-each select="marc:leader">
							<leader>
								...
								<xsl:variable name="detectMarcRecordType">
									<xsl:choose>
								...
								<xsl:value-of
									select="concat($recordLenght, $recordStatus, $detectMarcRecordType, $bibLvl, ' ', $controlType, '22', $baod, $encLvl, $dcf, ' 450 ')"
								/>
							</leader>
						</xsl:for-each>
					...
					<datafield tag="012">
									...
									<xsl:variable name="loc">
										<xsl:choose>
											<xsl:when
												...
												<xsl:value-of
												select="datafield[@tag = '040']/subfield[@code = 'b']"
												/>
											</xsl:when>
											<xsl:otherwise>
						...
						<!--								</xsl:for-each>-->
						<!--								<xsl:for-each select="marc:subfield[@code='b']">-->
						<!--									<subfield code="?"><xsl:value-of select="text()" /></subfield>-->
						<!--								</xsl:for-each>-->
						<!--							</datafield>-->
						<!--						</xsl:for-each>-->
					...
					-->
						...
						<!--									</subfield>-->
						<!--								</xsl:for-each>-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='o']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='p']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='r']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='s']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='t']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='u']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								<xsl:for-each select="marc:subfield[@code = 'x']">-->
						<!--									<subfield code="x">-->
						<!--										<xsl:value-of select="text()"/>-->
						<!--									</subfield>-->
						...
						<!--									</subfield>-->
						<!--								</xsl:for-each>-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='?']"><subfield code="3"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--							</datafield>-->
						<!--						</xsl:for-each>-->
						...
						<!--									</subfield>-->
						<!--								</xsl:for-each>-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='f']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='g']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								<xsl:for-each select="marc:subfield[@code = 'k']">-->
						<!--									<subfield code="j">-->
						<!--										<xsl:value-of select="text()"/>-->
						<!--									</subfield>-->
						<!--								</xsl:for-each>-->
						<!--								&lt;!&ndash;<xsl:for-each select="marc:subfield[@code='l']"><subfield code="?"><xsl:value-of select="text()" /></subfield></xsl:for-each>&ndash;&gt;-->
						<!--								<xsl:for-each select="marc:subfield[@code = 'n']">-->
						<!--									<subfield code="d">-->
						<!--										<xsl:value-of select="text()"/>-->
						<!--									</subfield>-->
	...
	<xsl:template name="tokenizeSubfield">
		...
		<xsl:choose>
			<xsl:when test="contains($list, $delimiter) and substring-after($list,$delimiter) != ''">
				...
				<xsl:call-template name="tokenizeSubfield">
					<!-- graph anything left in another variable -->
	...
	<!--				</subfield>-->
	<!--			</xsl:when>-->
	<!--			&lt;!&ndash; What to do if thesaurus source is not specified (ind2 = 4)? &ndash;&gt;-->
	<!--			<xsl:when test="$ind = 5">-->
	<!--				<subfield code="2" xmlns="http://www.loc.gov/MARC21/slim">-->

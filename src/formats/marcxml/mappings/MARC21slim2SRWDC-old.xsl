...
-->
	...
	<xsl:template match="marc:record">
		...
		<xsl:for-each select="datafield[@tag=100]|datafield[@tag=110]|marc:datafield[@tag=111]|marc:datafield[@tag=700]|marc:datafield[@tag=710]|marc:datafield[@tag=711]|marc:datafield[@tag=720]">
			<creator>

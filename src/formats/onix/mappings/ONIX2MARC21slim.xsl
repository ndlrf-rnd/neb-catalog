<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.loc.gov/MARC21/slim" version="1.0">
    ...
    <record
      ...
      <xsl:for-each select="b067[text()='01' or text()='02']">
        <xsl:call-template name="datafield">
          ...
          <xsl:with-param name="subfields">
            <subfield code="a">
              <xsl:value-of select="../b069"/>
            </subfield>
            <subfield code="2">
              <xsl:value-of select="../b068"/>
            </subfield>
          </xsl:with-param>
        </xsl:call-template>
      </xsl:for-each>
      ...
      <xsl:for-each select="othertext">
        <xsl:choose>
          ...
          <!--        <xsl:when test="d102='04'"></xsl:when>-->
          ...
          <!--        <xsl:when test="d102='09'"></xsl:when>-->
          <xsl:when test="d102='10'">
            <xsl:call-template name="datafield">
              <xsl:with-param name="tag">520</xsl:with-param>
              <xsl:with-param name="ind1">1</xsl:with-param>
              <xsl:with-param name="ind2">#</xsl:with-param>
          ...
          <!--        <xsl:when test="d102='11'"></xsl:when>-->
          <xsl:when test="d102='12'">
            <xsl:call-template name="datafield">
              <xsl:with-param name="tag">520</xsl:with-param>
              <xsl:with-param name="ind1">2</xsl:with-param>
              <xsl:with-param name="ind2">#</xsl:with-param>
          ...
          <!--        <xsl:when test="d102='15'"></xsl:when>-->
          <!--        <xsl:when test="d102='16'"></xsl:when>-->
          <xsl:when test="d102='17'">
            <xsl:call-template name="datafield">
          ...
          <!--        <xsl:when test="d102='24'"></xsl:when>-->
          <xsl:when test="d102='25'">
            <xsl:call-template name="datafield">
              <xsl:with-param name="tag">520</xsl:with-param>
              <xsl:with-param name="ind1">2</xsl:with-param>
              <xsl:with-param name="ind2">#</xsl:with-param>
          ...
          <!--        <xsl:when test="d102='34'"></xsl:when>-->
        </xsl:choose>
      </xsl:for-each>
      <xsl:for-each select="mediafile">
        <xsl:call-template name="datafield">
          ...
          <xsl:with-param name="subfields">
            ...
            <xsl:if test="ImageWidth or ImageHeight">
              <subfield code="x">
            ...
            <xsl:for-each select="ImageHeight">
              <subfield code="x">
                <xsl:text>height: </xsl:text><xsl:value-of select="."/><xsl:text> pixels</xsl:text>
              </subfield>
            </xsl:for-each>
            <xsl:for-each select="f259">
              <subfield code="x">
                <xsl:value-of select="."/>
              </subfield>
            </xsl:for-each>
